...
import com.example.md.myfirstapp.Feelings.FeelingHappy

class FeelingHappyControl : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_feeling_happy_control)
        ...
        buttonAdd!!.setOnClickListener {
            val fh = FeelingHappy(editTextUserInput!!.text.toString())
            pDB!!.addFeelingHappy(fh)
            printDatabase()
        }
        buttonDelete!!.setOnClickListener {
            val fh = editTextUserInput!!.text.toString()
            pDB!!.deleteFeelingHappy(fh)
            printDatabase()
        }
